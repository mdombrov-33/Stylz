    ...
    <>
      <section className="grid">
        <div>
          ...
          <p className="mt-6">
            Message us on <span className="underline">Whatsapp</span> or through
            Live Chat using button below(ENGLISH ONLY).
          </p>
          <p className="py-6 font-bold">Or Message Us on WhatsApp.</p>
          <button className="btn w-96">
        ...
        <div>
          ...
          <p>
            <span className="underline">Email us</span> anytime and we will get
      ...
      <section className="md:ml-36">
        ...
        <div className="mt-10">
          <h3 className="my-6 text-2xl font-bold uppercase">stylzmc limited</h3>
          <p>123 Fashion Ave, Suite 456, New York</p>
          <p>NY 10001, USA</p>
          <p>United States of America</p>
          <p>sales@stylzmc.com</p>
